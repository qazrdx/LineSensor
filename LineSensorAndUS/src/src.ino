...
float readLineSensorsFront() {
  // ---------- THE INPUT VALUES from the line Sensor {BEGIN}nt
  float lineError = 0;
  ...
  // Serial.print(val7); Serial.println(" :: ");
...
float readLineSensorsBack() {
  ...
  // here "lineError" is a GLOBAL constant
  switch (val)   {
      case B00001: lineError =  2.0; break;
      case B00011: lineError =  2.0; break;
      case B00111: lineError =  4.0/3.0; break;
      case B01111: lineError =  2.0/3.0; break;
      case B01110: lineError =  0; break;
      case B11110: lineError =  -2.0/3.0; break;
      case B11100: lineError =  -4.0/3.0; break;
      case B11000: lineError =  -2.0; break;
      case B10000: lineError =  -2.0; break;

      case B11111: lineError =  0; break;
      default:
          lineError = 102;
        break;
  }
...
void loop() {
  ...
  // y_axis = 50;
  // rotation = 0;
  // mecanumRun(x_axis, y_axis,  rotatio);
...
//
// float front_xdelta = error7 * 1.5;
// float back_xdelta = error5 * 1;
//
// float total_xdelta = (front_xdelta < back_xdelta) ? front_xdelta : back_xdelta;
// float total_horizontal_inclination = front_xdelta - back_xdelta;
//
// Serial.print("X- Delta"); Serial.println(total_xdelta);
// Serial.print("angular"); Serial.println(total_horizontal_inclination);
// delay(1000);
